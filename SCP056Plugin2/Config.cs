...
namespace SCP056Plugin
{
    ...
    public class Config : IConfig
    {
        ...
        [Description("ConsoleMessages when 056 changes to ClassD")]
        public string ClassDMessage { get; set; } = "Your disguise has changed to: Class";
        public string ClassDHint { get; set; } = "You're changed to a Class-D Personnel!";

        [Description("ConsoleMessages when 056 changes to Scientist")]
        public string ScientistMessage { get; set; } = "Your disguise has changed to: Scientist";
        public string ScientistHint { get; set; } = "You're changed to a Scientist Personnel!";

        [Description("ConsoleMessages when 056 changes to Facility Guard")]
        public string GuardMessage { get; set; } = "Your disguise has changed to: Facility Guard";
        public string GuardHint { get; set; } = "You're changed to a Facility Guard!";
